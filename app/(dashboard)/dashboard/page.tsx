...
function Dashboard() {
  ...
  return (
    <div className="p-6 lg:p-8 space-y-5">
      ...
      {noAccount && (
        // Only members see this: an owner without Instagram is sent to
        // /setup/instagram instead, and a member can't connect one themselves.
        <div className="flex items-start gap-3 bg-amber-50 border border-amber-200 rounded-2xl p-4">
          <AlertCircle className="w-5 h-5 text-amber-500 shrink-0 mt-0.5" />
          <div className="flex-1">
            <p className="text-sm font-semibold text-amber-900">Waiting for the workspace owner to connect Instagram</p>
            <p className="text-xs text-amber-700 mt-0.5">
              Automations start working here once they do. Meanwhile you can switch to another workspace from the sidebar.
            </p>
          </div>
        </div>
      )}
