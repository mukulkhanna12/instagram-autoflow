...
import { Scroll3D } from "@/components/landing/scroll-3d";
    ...
    <div className="min-h-screen bg-white text-gray-950">
        ...
        <div>
          ...
          <h1 className="mt-6 text-4xl sm:text-5xl lg:text-6xl font-extrabold tracking-tight leading-[1.05]">
            ...
            <span className="relative whitespace-nowrap">
              <span className="absolute inset-x-0 bottom-1 sm:bottom-2 h-3 sm:h-5 bg-lime -rotate-1 rounded" aria-hidden />
          ...
          <div className="mt-9 flex flex-wrap items-center gap-4">
            <Link
              href="/login"
              className="inline-flex items-center gap-2 h-12 px-6 rounded-full bg-gray-950 text-white text-base font-bold hover:bg-gray-800 transition-colors"
            >
              Get started free <ArrowRight className="w-4 h-4" />
            </Link>
            <a href="#how" className="inline-flex items-center h-12 px-5 rounded-full border-2 border-gray-200 text-base font-bold hover:border-gray-950 transition-colors">
              See how it works
            </a>
          </div>
      ...
      <section className="bg-[#f3f4f1]">
        <div className="max-w-6xl mx-auto px-5 py-20">
          ...
          <h2 className="mt-4 text-3xl sm:text-4xl font-extrabold tracking-tight max-w-3xl leading-[1.08]">
              ...
              <div className="mt-12 grid md:grid-cols-3 gap-5">
                {[
                  ...
                  <div key={c.big} className={i === 0 ? "rounded-3xl p-7 bg-gradient-to-br from-brand-600 to-brand-900 text-white" : "rounded-3xl p-7 bg-white"}>
                    ...
                    <p className="mt-5 text-3xl font-extrabold tracking-tight">{c.big}</p>
      ...
      <section id="how" className="bg-gray-950 text-white scroll-mt-20">
        <div className="max-w-6xl mx-auto px-5 py-20">
          ...
          <h2 className="mt-4 text-3xl sm:text-4xl font-extrabold tracking-tight">Three steps. No flowcharts.</h2>
      ...
      {/* Know what works */}
      <section className="max-w-6xl mx-auto px-5 py-20 grid lg:grid-cols-2 gap-14 items-center">
        <div>
          <p className="text-sm font-bold uppercase tracking-[0.14em] text-brand-700">Analytics</p>
          <h2 className="mt-4 text-3xl sm:text-4xl font-extrabold tracking-tight leading-[1.08]">Know what works</h2>
        ...
        <div className="rounded-[2rem] bg-[#eceee9] p-4 sm:p-5">
          <div className="grid grid-cols-2 gap-4">
            <div className="rounded-3xl p-5 bg-gradient-to-br from-brand-600 to-brand-900 text-white">
              ...
              <p className="text-3xl font-extrabold mt-3">1,284</p>
            ...
            <div className="rounded-3xl p-5 bg-white">
              ...
              <p className="text-3xl font-extrabold mt-3">64%</p>
      ...
      <section className="max-w-6xl mx-auto px-5 py-20">
        <Scroll3D strength={0.7}>
          <div className="rounded-[2.5rem] bg-gradient-to-br from-brand-700 to-brand-950 text-white px-8 py-16 text-center relative overflow-hidden">
            ...
            <h2 className="text-3xl sm:text-4xl font-extrabold tracking-tight">Get started with AutoFlow today</h2>
            <p className="mt-4 text-lg text-brand-100">Connect Instagram, write one message, and let your next reel do the work.</p>
            <Link
              href="/login"
              className="mt-8 inline-flex items-center gap-2 h-12 px-6 rounded-full bg-lime text-gray-950 text-base font-extrabold hover:bg-lime-400 transition-colors"
            >
