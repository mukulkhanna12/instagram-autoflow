    ...
    <>
      {open && (
        <div
          ...
          className="fixed z-50 inset-x-3 bottom-3 top-16 sm:inset-auto sm:bottom-24 sm:right-6 sm:w-[400px] sm:h-[min(640px,calc(100vh-8rem))] flex flex-col overflow-hidden rounded-3xl bg-white shadow-2xl ring-1 ring-black/5"
        >
          {/* Header */}
      ...
      <button
        ...
        className={cn(
          "fixed bottom-5 right-5 sm:bottom-6 sm:right-6 z-50 flex h-14 items-center gap-2 rounded-full shadow-xl transition-all cursor-pointer",
